...
export function ProjectCaseStudy({ slug }: { slug: string }) {
  ...
  return (
    <div className="relative min-h-screen overflow-x-clip bg-[#0b0d10] px-4 pb-20 pt-28 text-white md:px-8" dir={direction}>
        ...
        <Reveal className="space-y-6">
          ...
          <div className="grid gap-8 lg:grid-cols-[0.86fr_1.14fr]">
            <div className="space-y-5">
              <h1 className="max-w-4xl text-5xl font-black leading-[0.96] tracking-[-0.05em] text-white md:text-7xl">
                {project.title}
              </h1>
              <p className="max-w-2xl text-base leading-8 text-white/60 md:text-lg">{project.story}</p>
          ...
          <Card className="p-7 md:p-8">
            <div className="grid gap-8 lg:grid-cols-[1fr_auto] lg:items-end">
              <div>
                ...
                <p className="mt-4 max-w-3xl text-3xl font-black leading-[1.04] tracking-[-0.04em] text-white md:text-5xl">
                  {copy.next}
                </p>
